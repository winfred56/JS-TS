        ...
        <div className="bg-background text-center pt-10 px-5 md:px-20 text-body-text">
            ...
            <div className="relative flex flex-row items-center text-center mt-5 mb-10 md:mb-20 justify-center space-x-2">
                <h1 className="text-white font-Headings font-semibold md:px-44 text-4xl md:text-7xl">We build top
                    <span className="inline-block px-2"><img width="50" height="300" loading="eager" decoding="async" className="w-[20px] lg:w-[32px] xl:w-[30px]" alt="" src={diamond}/></span>
                    notch websites that help your brand grow ultrafast
                    <span className="inline-block px-2"><img width="50" height="300" loading="eager" decoding="async" className="w-[20px] h-[20px] lg:w-[40px] lg:h-[40px] xl:w-[32px] xl:h-[32px]" alt="" src={bolt}/></span>
                </h1>
            </div>
