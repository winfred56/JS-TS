...
export default function Hero() {
    return(
        <div className="px-20 py-4 pt-20 grid grid-flow-row-dense grid-cols-1 md:grid-cols-2 bg-black">
            <div className="">
                <p className="text-sm pt-24 text-white text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <h2 className="pt-2 pb-7 text-7xl text-white font-medium text-left">Hi, I am Winfred. This is my favorite work</h2>
            ...
            <div className="justify-items-center">
                ...
                <img src={person2} className="hidden md:flex absolute right-0 top-20" alt="person" />
            </div>
        </div>
    )
}